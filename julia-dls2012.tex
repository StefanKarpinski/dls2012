...
% TODO: introduce <: syntax in this section
...
%We find this style to be a good fit for
...
%special cases that can be implemented more efficiently.
%We also find it a great simplification to support only
...
\bibitem[Almasi and Padua(2001)]{majic}
...
%\newblock ISBN 978-3-540-42862-6.

\bibitem[An et~al.(2011)An, Chaudhuri, Foster, and Hicks]{rubydust}
J.-h.~D. An, A.~Chaudhuri, J.~S. Foster, and M.~Hicks.
\newblock Dynamic inference of static types for ruby.
\newblock \emph{SIGPLAN Not.}, 46:\penalty0 459--472, Jan. 2011.
%\newblock ISSN 0362-1340.
%\newblock \doi{http://doi.acm.org/10.1145/1925844.1926437}.
%\newblock URL \url{http://doi.acm.org/10.1145/1925844.1926437}.
...
\bibitem[Bobrow et~al.(1988)Bobrow, DeMichiel, Gabriel, Keene, Kiczales, and
  Moon]{closspec}
D.~G. Bobrow, L.~G. DeMichiel, R.~P. Gabriel, S.~E. Keene, G.~Kiczales, and
  D.~A. Moon.
\newblock Common lisp object system specification.
\newblock \emph{SIGPLAN Not.}, 23:\penalty0 1--142, September 1988.
%\newblock ISSN 0362-1340.
%\newblock \doi{http://doi.acm.org/10.1145/885631.885632}.
%\newblock URL \url{http://doi.acm.org/10.1145/885631.885632}.
...
\bibitem[Chang et~al.(2009)Chang, Smith, Reitmaier, Bebenita, Gal, Wimmer,
  Eich, and Franz]{tracingjit2}
...
%\newblock ISBN 978-1-60558-375-4.
%\newblock \doi{http://doi.acm.org/10.1145/1508293.1508304}.
%\newblock URL \url{http://doi.acm.org/10.1145/1508293.1508304}.

\bibitem[Chauhan and Kennedy(2001)]{telescopingvectorization}
...
%\newblock ISBN 1-58113-410-X.
%\newblock \doi{http://doi.acm.org/10.1145/377792.377812}.
%\newblock URL \url{http://doi.acm.org/10.1145/377792.377812}.

\bibitem[Chauhan and Kennedy(2004)]{slicehoisting}
A.~Chauhan and K.~Kennedy.
...
%\newblock ISBN 978-3-540-21199-0.

\bibitem[Chevalier-Boisvert et~al.(2010)Chevalier-Boisvert, Hendren, and
  Verbrugge]{matlabspecializer}
...
\newblock In R.~Gupta, editor, \emph{Compiler Construction}, volume 6011 of
  ...
  Heidelberg, 2010.
%\newblock ISBN 978-3-642-11969-9.
...
\bibitem[De~Rose et~al.(1996)De~Rose, Gallivan, Gallopoulos, Marsolf, and
  Padua]{falcon}
...
%\newblock ISBN 978-3-540-60765-6.
%\newblock URL \url{http://dx.doi.org/10.1007/BFb0014205}.
%\newblock 10.1007/BFb0014205.
...
\bibitem[Furr et~al.(2009{\natexlab{a}})Furr, An, and Foster]{profileguided}
...
\bibitem[Furr et~al.(2009{\natexlab{b}})Furr, An, Foster, and Hicks]{druby}
...
\newblock In \emph{Proceedings of the 2009 ACM symposium on Applied Computing},
  SAC '09, pages 1859--1866, New York, NY, USA, 2009{\natexlab{b}}. ACM.
%\newblock ISBN 978-1-60558-166-8.
%\newblock \doi{http://doi.acm.org/10.1145/1529282.1529700}.
%\newblock URL \url{http://doi.acm.org/10.1145/1529282.1529700}.

\bibitem[Gal et~al.(2009)Gal, Eich, Shaver, Anderson, Mandelin, Haghighat,
  Kaplan, Hoare, Zbarsky, Orendorff, Ruderman, Smith, Reitmaier, Bebenita,
  Chang, and Franz]{tracingjit}
...
%\newblock ISBN 978-1-60558-392-1.
%\newblock \doi{http://doi.acm.org/10.1145/1542476.1542528}.
%\newblock URL \url{http://doi.acm.org/10.1145/1542476.1542528}.
...
\newblock In B.~Krieg-Brückner, editor, \emph{ESOP '92}, volume 582 of
  ...
  Heidelberg, 1992{\natexlab{a}}.
%\newblock ISBN 978-3-540-55253-6.

\bibitem[Henglein(1992{\natexlab{b}})]{taggingopt}
F.~Henglein.
...
\newblock In \emph{Proceedings of the 1992 ACM conference on LISP and
  ...
  1992{\natexlab{b}}. ACM.
%\newblock ISBN 0-89791-481-3.
%\newblock \doi{http://doi.acm.org/10.1145/141471.141542}.
%\newblock URL \url{http://doi.acm.org/10.1145/141471.141542}.
...
\bibitem[Kennedy et~al.(2001)Kennedy, Broom, Cooper, Dongarra, Fowler, Gannon,
  Johnsson, Mellor-Crummey, and Torczon]{telescoping}
...
\newblock \emph{Journal of Parallel and Distributed Computing}, 61\penalty0
  (12):\penalty0 1803 -- 1826, 2001.
%\newblock ISSN 0743-7315.
%\newblock \doi{10.1006/jpdc.2001.1724}.
%\newblock URL
...
\bibitem[Mehnert(2010)]{dylantypes}
H.~Mehnert.
...
%\newblock ISBN 978-1-4503-0470-2.
%\newblock \doi{http://doi.acm.org/10.1145/1869643.1869645}.
%\newblock URL \url{http://doi.acm.org/10.1145/1869643.1869645}.
...
\bibitem[Siek and Taha(2007)]{gradualobjects}
J.~Siek and W.~Taha.
...
%\newblock ISBN 978-3-540-73588-5.

\bibitem[Tobin-Hochstadt and Felleisen(2008)]{typedscheme}
...
%\newblock \doi{http://doi.acm.org/10.1145/1328438.1328486}.
%\newblock URL \url{http://doi.acm.org/10.1145/1328438.1328486}.
