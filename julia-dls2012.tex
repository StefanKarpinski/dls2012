...
\STATE $\forall i, \Gamma[1][V[i]] \leftarrow \text{Undef}$
...
It has attracted 600 mailing list subscribers, 1500 github followers,
...
making it easy for developers to contribute packages and for users to
use packages.
