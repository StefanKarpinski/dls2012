...
We forgo the following features in the interest of preserving
...
A tuple is used to represent the type of a method's arguments.
...
% TODO: specificity involving type parameters, \cite{modularmultipledispatch}
...
remove run-time type manipulations: checking, applying, and removing
...
Another category of techniques involves altering a dynamic language
...
\acks 
We wish to thank our funding agencies for support from
Department of Energy grant DE-SC0002099, National Science Foundation
grant CCF-0832997, also grants from VMWare and Citigroup.
