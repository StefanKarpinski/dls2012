...
We validate our design by implementing Julia's standard library---
which encompasses most of the core functionality of standard technical
computing environments---in the languge itself. As a result, our library
code is more generic and compact, and it is possible to inline library code
into user code and vice-versa.
